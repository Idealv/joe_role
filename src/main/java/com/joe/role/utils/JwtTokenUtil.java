...
public class JwtTokenUtil {
    ...
    public String generateAccessToken(SecurityUser userDetail) {
        Map<String, Object> claims = generateClaims(userDetail);//自定义字段user_id->1(举例)
        claims.put(CLAIM_KEY_AUTHORITIES, authoritiesToArray(userDetail.getAuthorities()).get(0));//scope->
    ...
    private String generateAccessToken(String subject, Map<String, Object> claims) {
        return generateToken(subject, claims, securityConfig.getExpiration());
    }
    ...
    private String generateToken(String subject, Map<String, Object> claims, long expiration) {
        return Jwts.builder()
                ...
                .signWith(SIGNATURE_ALGORITHM, securityConfig.getSecret())
                .compact();
    }
